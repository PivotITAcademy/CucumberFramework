...
public class CreateIssueAPIStepDefinition {
	...
	public void i_extract_the_project_id_and_issue_type_id() {
		...
		//Compare two json resposnes.
		assertEquals(JsonParser.parseString(context.response.asString()), JsonParser.parseString(new String()));
	...
	public void i_invoke_the_create_issue_api() {
		...
		//Read the json file
		org.json.simple.JSONObject jsonObject = JsonReader.readJsonFile("CreateIssue.json");
